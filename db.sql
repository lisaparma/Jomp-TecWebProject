...
INSERT INTO Utenti(Id, Username, Password, Nome, Cognome, Email)
VALUES
(1, 'Saretta17', 'abc123', 'Sara', 'Feltrin', 'sara-17@hotmail.it');

INSERT INTO Annunci(Codice, Titolo, Tipo, Data)
VALUES
(1, 'Cercasi segrataria', 'Tipo?', '28/11/17');

INSERT INTO Aziende(Codice, Nome, Tipo, Città)
VALUES
(1, 'Aziendissima', 'Elettronica', 'Cornuda');

INSERT INTO Consultazioni(NumConsult, CodUtente, CodAnnuncio)
VALUES
(1, '1', '1');

INSERT INTO Inserzioni(NumInser, CodAzienda, CodAnnuncio)
VALUES
(1, '1', '1');
